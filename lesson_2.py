...
def list():
    ...
    characters_list = ['Тирион Ланнистер', 'Серсея Ланнистер', 'Джейме Ланнистер', 'Тайвин Ланнистер', 'Кейтилин Старк', 
                       'Робб Старк', 'Эддард Старк', 'Санса Старк', 'Арья Старк', 'Брандон Старк']
...
def set():
    ...
    characters_set = {'Тирион Ланнистер', 'Серсея Ланнистер', 'Джейме Ланнистер', 'Тайвин Ланнистер', 'Кейтилин Старк', 
                      'Робб Старк', 'Эддард Старк', 'Санса Старк', 'Арья Старк', 'Брандон Старк'}
